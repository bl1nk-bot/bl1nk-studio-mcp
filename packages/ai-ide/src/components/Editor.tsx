...
import { Eye, EyeOff, Split, Clock, ChevronLeft } from "lucide-react";
...
export function Editor({ note, onChange, onEmojiChange, onBack }: EditorProps) {
  ...
  const showEdit    = mode === "edit" || (mode === "split" && (!isMobile || mobileTab === "edit"));
  const showPreview = mode === "preview" || (mode === "split" && (!isMobile || mobileTab === "preview"));
  ...
  return (
    <div className="flex-1 flex flex-col min-w-0 overflow-hidden">
          ...
          <div className="relative shrink-0">
            <button
              ...
              className={cn(
                ...
                onEmojiChange ? "hover:bg-[rgba(0,188,212,0.1)] cursor-pointer" : "cursor-default",
              )}
            ...
            {emojiOpen && onEmojiChange && (
              <EmojiPicker
                onSelect={emoji => { onEmojiChange(note.id, emoji); }}
          ...
          {(["edit", "preview"] as const).map(tab => (
            <button
              ...
              style={{
                ...
                borderBottom: mobileTab === tab ? "2px solid var(--teal)" : "2px solid transparent",
              }}
            >
      ...
      <div className="flex flex-1 min-h-0 overflow-hidden">
        ...
        {showEdit && (
          <div
            className={cn("flex flex-col overflow-hidden", isSplit ? "w-1/2 border-r" : "w-full")}
        ...
        {showPreview && (
          <div
            className={cn("flex flex-col overflow-hidden", isSplit ? "w-1/2" : "w-full")}
