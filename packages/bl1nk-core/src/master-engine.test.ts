...
// @ts-ignore - เราจงใจให้มันพังก่อนเพราะยังไม่ได้สร้างไฟล์เหล่านี้ (TDD)
                    ...
                    characters: [
                        {
                            ...
                            powers: [{ system: "Logic", ability: "Reality Check", mechanics: "Calls out AI BS", cost: "Patience", limits: "High" }]
                        }
                    ]
                },
                timeline: {
