...
import { LABEL_PALETTE, type Label, labelsStore } from "../store/labels";
			...
			{activePanel === "views" && (
				...
				>
					...
					<div className="flex-1 overflow-y-auto">
						...
						<div
							className="px-3 pt-3 pb-2 border-t mt-2"
							style={{ borderColor: "var(--border)" }}
						>
