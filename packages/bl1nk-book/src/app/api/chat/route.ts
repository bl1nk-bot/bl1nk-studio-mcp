...
import { McpOAuthService } from '@/lib/support/mcp/oauth-service';
import { SandboxManager } from '@/lib/support/sandbox/manager';
import {
  SUPPORT_SYSTEM_PROMPT,
  ORDER_LOOKUP_SKILL,
  BILLING_SKILL,
  TECHNICAL_SKILL,
} from '@/lib/support/agents/skills-data';
import { getAgentModeById, parseSlashCommand } from '@/lib/support/agents/cli-bridge';
...
export async function POST(req: Request) {
  try {
    ...
    // Get or create a sandbox-backed session (only when a sandbox key is configured)
